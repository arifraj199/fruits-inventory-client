...
const AddInventory = () => {
  ...
  return (
    <div>
      ...
      >
        <input
          className="mb-2" placeholder="items name"
          {...register("name", { required: true, maxLength: 20 })}
        />
        <input
          className="mb-2" placeholder="items price" type="number"
        ...
        />
        <input
          className="mb-2" placeholder="items photo url"
          {...register("picture")}
        />
        <textarea
          className="mb-2" placeholder="short description"
          {...register("description", { required: true, maxLength: 150 })}
        />
        <input className="mb-2 btn btn-success" type="submit" value="Add Item" />
      </form>
    </div>
  );
};
